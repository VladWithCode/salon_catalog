    ...
    matchesSelector(event, selector) {
        ...
        switch (selector) {
            ...
            case "products-grid":
                return (
                    target.id === "products" ||
                    event.detail.requestConfig.elt.closest("#products")
                );

            case "category-filter":
                return (
                    event.detail?.elt?.matches?.("[data-category-filter]") ||
                    event.target.matches?.("[data-category-filter]")
                );

            case "add-to-cart":
                return (
                    event.detail?.elt?.matches?.("[data-add-to-cart]") ||
            ...
            default:
                ...
                return (
                    ...
                    Boolean(event.detail.requestConfig?.elt?.closest(selector))
                );
        }
    }
