...
func QuickActions() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<script>\n    document.addEventListener('DOMContentLoaded', function () {\n        eventManager.registerClick('quick-actions-toggle', (e) => {\n            const list = document.getElementById('quick-actions-list');\n            const isOpen = list.dataset.quickActionsOpen === 'true';\n            const duration = 0.15;\n\n            if (isOpen) {\n                gsap.to(list, {\n                    height: 0,\n                    duration,\n                    ease: 'power2.out',\n                });\n                list.dataset.quickActionsOpen = 'false';\n            } else {\n                gsap.to(list, {\n                    height: 'auto',\n                    duration,\n                    ease: 'power2.out',\n                });\n                list.dataset.quickActionsOpen = 'true';\n            }\n        });\n    });\n</script><div class=\"px-4 \"><button id=\"quick-actions-toggle\" class=\"flex w-full justify-between py-2 text-primary focus:outline-accent\" data-click-handler-selector=\"quick-actions-toggle\"><h3 class=\"text-lg font-semibold text-gray-900\">Acciones Rápidas</h3>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = components.ChevronIcon("w-6", nil).Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
