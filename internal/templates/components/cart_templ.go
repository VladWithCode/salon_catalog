...
func EmptyCart() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 45, "<div class=\"flex flex-col items-center justify-center h-full text-center py-12\"><div class=\"text-gray-300 mb-6\"><svg class=\"w-20 h-20 mx-auto\" fill=\"currentColor\" viewBox=\"0 0 20 20\"><path d=\"M3 1a1 1 0 000 2h1.22l.305 1.222a.997.997 0 00.01.042l1.358 5.43-.893.892C3.74 11.846 4.632 14 6.414 14H15a1 1 0 000-2H6.414l1-1H14a1 1 0 00.894-.553l3-6A1 1 0 0017 3H6.28l-.31-1.243A1 1 0 005 1H3zM16 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM6.5 18a1.5 1.5 0 100-3 1.5 1.5 0 000 3z\"></path></svg></div><h3 class=\"text-xl font-semibold text-gray-500 mb-2\">No has seleccionado nada aún</h3><p class=\"text-gray-400 mb-6\">Explora nuestro catálogo y agrega los artículos que te gustarían para tu evento</p><div class=\"space-y-2\"><button class=\"block px-6 py-2 text-light bg-primary/90 rounded-sm cursor-pointer hover:bg-primary hover:scale-102 active:scale-95 transition-[background,_transform] font-medium\" data-cart-close data-click-handler-selector=\"browse-trigger,cart-close\" data-browse-catalog>Regresar al catálogo</button></div></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
