...
// GetProductBySlug is defined in internal/routes/products_public.go — it
// now serializes publicProductDTO instead of db.Product directly, and is
// injectable for tests via getProductBySlugHandler.
