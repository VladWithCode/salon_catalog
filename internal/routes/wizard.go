...
func RegisterWizardRoutes(router *customServeMux, cartSessions *session.CartManager, csrfGuard *appsecurity.CSRFGuard) {
	// Catalog wizards
	...
	router.HandleFunc("POST /wizard/{wizard_id}/complete", withProtectedCartSession(csrfGuard, cartSessions, CompleteWizardAndAddToCart))
